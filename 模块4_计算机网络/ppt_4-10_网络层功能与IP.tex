...
\begin{frame}{分类编址}
    \begin{center}
        \begin{tikzpicture}[>=stealth]
            ...
            \draw (0,2.0) -- (6,2.0);
            \foreach \class/\pattern/\range/\start/\ypos in {
                ...
                \edef\myfill{tmp\class!20}
                \node[draw,minimum width=6cm,minimum height=0.7cm,fill=\myfill] at (0,\ypos) {\textbf{\class类}: \pattern \hspace{1em} \range};
            }
        \end{tikzpicture}
    \end{center}
    \vspace{0.3em}
